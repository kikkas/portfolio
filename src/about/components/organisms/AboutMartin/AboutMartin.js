    ...
    <div className="about">
        ...
        <div className="about__wrapper">
            <div className="about__innerwrapper">
                <div className="about__title">The story</div>
                <div className="about__description">I am a multidisciplinary product designer, experienced in creating digital strategies,
                ...
                <div className="about__title">What is next?</div>
                <div className="about__description">In my free time I enjoy ideating on startup ideas, exploring new products and getting smarter about <span><a className="information" href="https://www.udacity.com/course/data-analyst-nanodegree--nd002"> data science</a></span>.
