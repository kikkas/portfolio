...
export default class Navbar extends React.Component {
  ...
  handleClick(event) {
    if (
      !this.state.closed &&
      !/navbar/g.test(event.target.className) &&
      event.target.parentNode &&
      !/navbar/g.test(event.target.parentNode.className)
    ) {
      this.setState({
        closed: true,
      })
        ...
        <div className="navbar__content">
          ...
          <div className="navbar__body">
            ...
            <div className="navbar__column">
              ...
              <div className="navbar__column-link">
                How Intercom makes you interact with users
              </div>
              <div className="navbar__column-link">
                What does the LIDAR mean?
              </div>
            </div>
