...
import ServiceListItem from 'components/molecules/ServiceListItem'
...
export default class ServiceList extends React.Component {
  constructor() {
    ...
    this.services = [
      {
        title: 'UX/UI design',
        description: 'For mobile apps, web, TV and any other digital or\n physical device that can be interacted with.',
        // icon: <TiLightbulb color="#3DCF62" size={36} />,
        icon: icon,
      },
      {
        title: 'Scaling design systems',
        description: 'User behaivour is always in patterns and design systems\n help to make the whole experience smoother.',
        icon: <FaEmpire color="#3DCF62" size={36} />,
      },
      {
        title: 'Build, measure, learn',
        description: 'Working with developers, managers and data analysts\n to deliver and measure impact. ',
        icon: <MdCamera color="#3DCF62" size={36} />,
      },
      {
        title: 'Innovation',
        description: 'Design is the process finding the most direct to needed outome. In many cases it means using distruptive technologies.',
